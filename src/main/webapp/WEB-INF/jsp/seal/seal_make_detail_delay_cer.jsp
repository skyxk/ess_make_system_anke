...
<div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
        <ul class="search" style="padding-left:10px;">
            <li><a class="button border-main icon-plus-square-o" href="javaScript:history.back(-1);"> 返回</a></li>
        </ul>
    </div>
    <div class="ub">
        <div class="body-content  f-s-14 c-6">
            <form method="post" class="form-x" action="${pageContext.request.contextPath}/seal/seal_make_do.html" id="seal_review_from" enctype="multipart/form-data">
                ...
                <div class="ub option">
                    ...
                    <div class="ub-f1"  id="sealStartTime" >
                        ${sealApply.sealStartTime}
                    </div>
                </div>
                <div class="ub option">
                    <div class="title f-w">印章终止时间：</div>
                    <div class="ub-f1" id="sealEndTime">
                        ${sealApply.sealEndTime}
                    </div>
                </div>
                <div class="ub option">
                    <div class="title f-w">
        ...
        <div class="rightContent ub-f1 ">
            ...
            <div class="ub option">
                ...
                <div class="ub-f1">
                    <input type="date" id="StarTime" name="StarTime" value="" />
                </div>
            </div>
            <div class="ub option">
            ...
            buttons:[{
                ...
                callback:function (dialog){
                    ...
                    var submitDate = {
                        ...
                        "sealStartTime":$("#sealStartTime").text(),
                        "cerIssuer":$("#cerIssuer").val(),
                        "sealEndTime":$("#sealEndTime").text(),
