        ...
        <div class="body-content  f-s-14 c-6">
            <form method="post" class="form-x" action="${pageContext.request.contextPath}/make/make_do.html" id="make_from" enctype="multipart/form-data">
                ...
                <div class="ub option">
                    ...
                    <div class="ub-f1" >
                        <a href="${pageContext.request.contextPath}/downLoadCert.html?certBase64=${sealApply.certificate.cerBase64}">
                            <span>点击下载</span>
                        </a>
                    </div>
                </div>
                ...
                <div class="ub option">
                    ...
                    <div class="ub-f1">
                        ...
                        <div class="uploader white" style="display: none;">
                ...
                <div class="ub option">
                    <div class="title f-w">图片宽度（mm）：</div>
                    <div class="ub-f1">
                        <input type="text" id="sealImageW" name="sealImageW"  value="" />
                    </div>
                </div>
                <div class="ub option">
                    <div class="title f-w">图片高度（mm）：</div>
                    <div class="ub-f1">
                        <input type="text" id="sealImageH" name="sealImageH"  />
                    </div>
                </div>
                <div class="ub option">
...
<script>
    ...
    function sealInfoSubmit(){
        if( isNull($("#gifImg").val()) && isNull($("#jpgImg").val())){
            ...
            formData.append('sealImageH', $('#sealImageH').val());
            formData.append('sealImageW', $('#sealImageW').val());
