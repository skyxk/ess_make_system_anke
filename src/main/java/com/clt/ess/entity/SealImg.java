...
public class SealImg {
    ...
    //图片上传方式 0UK读取，1用户上传
    private int sealImageH;
    //图片上传方式 0UK读取，1用户上传
    private int sealImageW;
    //图片上传方式 0UK读取，1用户上传
    ...
    public int getSealImageH() {
        return sealImageH;
    }

    public void setSealImageH(int sealImageH) {
        this.sealImageH = sealImageH;
    }

    public int getSealImageW() {
        return sealImageW;
    }

    public void setSealImageW(int sealImageW) {
        this.sealImageW = sealImageW;
    }
